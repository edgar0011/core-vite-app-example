...
module.exports = function (plop) {
  plop.setGenerator('Nano component', {
    description: 'Nano component controller logic',
    prompts: [
      {
        type: 'input',
        name: 'module',
    ...
    actions: [
      {
        ...
        templateFile: 'scripts/plop-templates/cui/nano-component/component.hbs',
      },
      {
        type: 'add',
        path: 'src/components/{{module}}/{{camelCase name}}.types.ts',
        templateFile: 'scripts/plop-templates/cui/nano-component/component.types.hbs',
      },
      {
        type: 'add',
        path: 'src/components/{{module}}/{{camelCase name}}.module.scss',
        templateFile: 'scripts/plop-templates/cui/nano-component/component.module.scss.hbs',
      },
      {
        type: 'add',
        path: 'src/components/{{module}}/{{camelCase name}}.stories.tsx',
        templateFile: 'scripts/plop-templates/cui/nano-component/component.stories.hbs',
      },
      {
        type: 'add',
        path: 'src/components/{{module}}/{{camelCase name}}.test.tsx',
        templateFile: 'scripts/plop-templates/cui/nano-component/component.test.hbs',
      },
      (data) => {
