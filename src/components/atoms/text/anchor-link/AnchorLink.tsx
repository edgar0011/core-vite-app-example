...
import type { AnchorLinkProps } from 'components/atoms/text/anchor-link/anchorLink.types'
import { Link } from 'components/atoms/text//Link'
import classes from 'components/atoms/text/anchor-link/anchorLink.module.scss'
